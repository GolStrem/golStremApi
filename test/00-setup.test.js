...
before(async () => {
  ...
  await db.query("INSERT INTO user (id, login, password, email, status, image) VALUES (1, 'invite', '$2b$10$4EEjLSLljyGUISGGPmitzeSGWALRZU3NVkyBewHGroEyGIeua46Iu', NULL, 1, NULL);");
